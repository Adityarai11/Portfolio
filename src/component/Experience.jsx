        ...
        className="my-20 text-center text-4xl">Experience</motion.h2>
         <div >{EXPERIENCES.map((experience,index)=>(
            <div key={index} className=" mb-8 flex flex-wrap lg:justify-center">
                ...
                initial = {{ opacity: 0, x: 100}}
                transition={{duration: 1.5}} 
                className="mb-2 font-semibold text-justify">
                    {experience.role} - <span className="text-sm text-purple-100 text-justify">
                        {experience.company}
                    </span>
                </motion.h6>
                <motion.p 
                ...
                className="text-justify mb-4 text-neutral-400">{experience.description}</motion.p>
